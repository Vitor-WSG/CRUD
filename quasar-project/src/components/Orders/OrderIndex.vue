<template>
  <div class="q-pa-xs q-ma-xs">
    <q-table title="teste" hide-pagination :rows="rows" :columns="columns">
      <template v-slot:top>
        ...
        <div class="col-xs-6" align="right">
          <q-btn color="primary" push label="Cadastrar" no-caps icon="add" @click="goToCreateOrder()"></q-btn>
        </div>
      ...
      <template v-slot:body-cell-action="props">
        <q-td :props="props">
          <div class="q-gutter-sm">
            ...
            <q-btn class="glossy" size="sm" no-caps push icon="delete" color="red" label="Excluir" @click="goToDeleteOrder()"/>
          </div>
        </q-td>
      </template>
    </q-table>
    ...
    <q-dialog v-model="createOrder" persistent >
      <q-card style="width: 700px; max-width: 80vw;">
        ...
        <q-card-section class="row items-center q-col-gutter-md">
          <div class="col-xs-4">
            <q-input outlined label="Código do pedido"></q-input>
          </div>
          <div class="col-xs-8">
            <q-input outlined label="Descrição do pedido"></q-input>
          </div>
        </q-card-section>
    ...
    <q-dialog v-model="deleteOrder" persistent>
      <q-card>
        <q-card-section class="row items-center">
